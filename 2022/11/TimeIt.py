...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', '--functions', default=('main1', 'main2', 'main3'), type=str, nargs='+',
    ...
    parser.add_argument('-rs', '--repetitions', type=int, default=3, help='Repetitions per measurement.')
